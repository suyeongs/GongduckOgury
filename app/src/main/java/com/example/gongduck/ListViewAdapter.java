...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView dateTV = (TextView) convertView.findViewById(R.id.textView1);
        TextView contentTV = (TextView) convertView.findViewById(R.id.textView2);

        //Data Seet(listViewItemList)에서 position에 위치한 데이터 참조 획득
        ListViewItem listViewItem = listViewItemList.get(position);

        // 아이템 내 각 위젯에 데이터 반영
        dateTV.setText(listViewItem.getDateStr());
        contentTV.setText(listViewItem.getContentStr());
